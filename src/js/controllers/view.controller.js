angular.module('mpn-generator').controller('viewCtrl', function($state, $scope, JSONService) {
    ...
    this.jsonPreview = "";
    this.jsonPreview = JSON.stringify(mpnData, null, 4);
...
$('#downloadButton').on('click', function(){
  $('.copiedPopup').addClass('active');
  setTimeout(function(){
     $('.copiedPopup').removeClass('active');
   }, 3000);
});
    ...
    this.viewAnimated = function() {
      ...
      if (mpnData.privacy.requestPermissions === 'Yes') {
          ...
          $privacyAccess.append(setContainer('green', 'We will not request access to device data or applications.', 'privacy-arrow'));
      }
